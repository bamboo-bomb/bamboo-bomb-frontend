    ...
    <div className="w-[32rem] h-screen m-auto fixed flex items-center justify-center inset-0 z-50 bg-black-50">
      <dialog className="w-[27rem] p-[1.6rem] block relative bg-transparent rounded-xl">
        <div className="w-full flex justify-between items-center">
          <p className="w-[11.4rem] px-[.4rem] py-[.2rem] flex justify-center items-center gap-[.4rem] text-[.8rem] text-red rounded-2xl bg-white-50">
        ...
        <div className="w-full p-[1rem] mt-[1.2rem] bg-white rounded-xl">
          <input
            className="block w-full p-[.4rem] border-b border-b-green-5 text-green-5 text-[1.2rem] placeholder:text-green-1"
            type="text"
            name="title"
            id="title"
            maxLength={20}
          ...
          <textarea
            ...
            className="block w-full max-h-[28rem] p-[.4rem] text-green-5 text-[1rem] placeholder:text-green-1 resize-none overflow-auto"
            id="content"
            maxLength={1000}
